state("MiniMetro")
{
	...
	//bool main_game_isin : "UnityPlayer.dll", 0x01436EBC, 0x4F4, 0x2B8, 0x8C, 0x40, 0x54, 0x18, 0x20, 0x8, 0xC, 0x7D;
	
	//Main<Main>.controller<GameController>.menu<Menu>.city<MenuCity>.game<Game>
	int menucity_game : "UnityPlayer.dll", 0x01436EBC, 0x4F4, 0x2B8, 0x8C, 0x40, 0x54, 0x18, 0x20, 0x8, 0x10, 0x28;
	
	//Main<Main>.controller<GameController>.game<Game>.scoreController<ScoreController>.score<int>
	int game_score : "UnityPlayer.dll", 0x01436EBC, 0x4F4, 0x2B8, 0x8C, 0x40, 0x54, 0x18, 0x20, 0x8, 0x54, 0x10;
	
	//Main<Main>.controller<GameController>.game<Game>.currentScreen<GameScreen>
	int game_state : "UnityPlayer.dll", 0x01436EBC, 0x4F4, 0x2B8, 0x8C, 0x40, 0x54, 0x18, 0x20, 0x8, 0xC8;
}
